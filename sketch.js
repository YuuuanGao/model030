...
function draw() {
 ...
 if(page==0) image(a,width*(1500/1920),80,0.18*width,0.18*width*1.99)
  if(page==1)image(b,width*(1500/1920)+2,80,0.18*width,0.18*width*2.41)
  if(page==2)image(c,width*(1500/1920)+2,80,0.18*width,0.18*width*2.41)
  pop()
